...
BORDER = pygame.Rect(WIDTH//2 - 5, 0, 10, HEIGHT) # need to make bottom border to take 1 health/life point away
...
BALL_VEL = 7
MAX_BULLETS = 3
SPACESHIP_WIDTH, SPACESHIP_HEIGHT = 75, 10
...
def draw_window(yellow, yellow_bullets, yellow_health):
    WIN.blit(SPACE, (0, 0))
...
def main():
    ...
    yellow = pygame.Rect(415, 450, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
